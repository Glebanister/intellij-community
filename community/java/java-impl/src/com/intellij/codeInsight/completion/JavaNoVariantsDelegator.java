...
public class JavaNoVariantsDelegator extends CompletionContributor implements DumbAware {
  ...
  public void fillCompletionVariants(@NotNull final CompletionParameters parameters, @NotNull final CompletionResultSet result) {
    ...
    // TODO: @Gleb.Marin Why it is not an "EarlyLookup" Contributor?
  ...
  private static void addNullKeyword(@NotNull CompletionParameters parameters, @NotNull CompletionResultSet result,
                                     CompletionKindsExecutor ckExecutor, JavaCompletionSession session) {
  ...
  private static void delegate(CompletionParameters parameters, CompletionResultSet result,
                               JavaCompletionSession session, String context,
  ...
  private static void suggestCollectionUtilities(CompletionParameters parameters, final CompletionResultSet result, PsiElement position,
                                                 @NotNull CompletionKindsExecutor ckExecutor, @NotNull JavaCompletionSession session) {
  ...
  static void suggestNonImportedClasses(CompletionParameters parameters, CompletionResultSet result,
                                        @Nullable JavaCompletionSession session, @NotNull String context,
                                        @NotNull CompletionKindsExecutor ckExecutor) {
    ckExecutor.addKind(withFillFunction(context, "non_imported_class", () -> {
      ...
      JavaClassNameCompletionContributor.addAllClasses(
        parameters, parameters.getInvocationCount() <= 2, result.getPrefixMatcher(),
        element -> {
